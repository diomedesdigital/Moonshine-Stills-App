...
PostDetail = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/post-detail/post-detail.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{selectedItem.title.rendered}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n <div *ngIf="selectedItem" class="selection">\n    <h2 [innerHTML]="selectedItem.title.rendered"></h2>\n    <div [innerHTML]="selectedItem.content.rendered"></div>\n </div>\n</ion-content>'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/post-detail/post-detail.html"*/
    }),
...
PrivacyPolicyPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'privacy-policy-page',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/privacy-policy/privacy-policy.html"*/'<ion-header class="privacy-header legal-header">\n  <ion-toolbar>\n    <ion-buttons start>\n      <button ion-button (click)="dismiss()">\n        <span showWhen="ios">Cancel</span>\n        <ion-icon name="md-close" showWhen="android,windows"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>\n      Privacy Policy\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class="privacy-content legal-content">\n  <p>Last modified: Nov 14, 2016</p>\n  <h4 class="legal-title">Welcome to ion2FullApp!</h4>\n  <p>Thanks for using our products and services (“Services”). Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>\n  <h4 class="legal-title">Using our Services</h4>\n  <p>You must follow any policies made available to you within the Services.</p>\n  <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>\n  <h4 class="legal-title">About these Terms</h4>\n  <p>We may modify these terms or any additional terms that apply to a Service to, for example, reflect changes to the law or changes to our Services. You should look at the terms regularly. We’ll post notice of modifications to these terms on this page. We’ll post notice of modified additional terms in the applicable Service. Changes will not apply retroactively and will become effective no sooner than fourteen days after they are posted. However, changes addressing new functions for a Service or changes made for legal reasons will be effective immediately. If you do not agree to the modified terms for a Service, you should discontinue your use of that Service.</p>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/privacy-policy/privacy-policy.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* ViewController */]])
], PrivacyPolicyPage);
...
TabsNavigationPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'tabs-navigation',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/tabs-navigation/tabs-navigation.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Listing" tabIcon="apps"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="Profile" tabIcon="person"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Notifications" tabIcon="notifications"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/tabs-navigation/tabs-navigation.html"*/
    }),
...
CounterInput = CounterInput_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'counter-input',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/components/counter-input/counter-input.html"*/'<button ion-button icon-only class="counter-icon" (click)="decrease()">\n  <ion-icon name="remove"></ion-icon>\n</button>\n<span class="counter-inner">{{counterValue}}</span>\n<button ion-button icon-only class="counter-icon" (click)="increase()">\n  <ion-icon name="add"></ion-icon>\n</button>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/components/counter-input/counter-input.html"*/,
        host: {
            'class': 'counter-input'
        },
        providers: [
...
FeedCategoriesComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/feeds/feed-categories/feed-categories.html"*/'<ion-header>\n	<ion-navbar>\n		<button menuToggle>\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>{{\'CATEGORIES\'}}</ion-title>\n	</ion-navbar>\n</ion-header>\n\n<ion-content>\n	<ion-list>\n		<ion-item *ngFor="let category of categories" (click)="loadCategory(category)">\n			<ion-icon [name]="category.icon" item-left></ion-icon>\n			<h2>{{category.title}}</h2>\n			<p>{{category.description}}</p>\n			<button ion-button item-right outline>More</button>\n		</ion-item>\n	</ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/feeds/feed-categories/feed-categories.html"*/,
...
FeedCategoryComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/feeds/feed-category/feed-category.html"*/'<ion-header>\n	<ion-navbar>\n		<button menuToggle>\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>{{category.title}}</ion-title>\n	</ion-navbar>\n</ion-header>\n\n<ion-content>\n	<section padding>\n		<h2>{{category.title}}</h2>\n		<p>{{category.description}}</p>\n	</section>\n	<ion-list>\n		<ion-item *ngFor="let item of category.items" (click)="loadFeeds(item.url)">\n			<h2>{{item.title}}</h2>\n			<p>{{item.description}}</p>\n			<button ion-button item-right outline>More</button>\n		</ion-item>\n	</ion-list>\n</ion-content>'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/feeds/feed-category/feed-category.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_3__shared_services_feed_service__["a" /* FeedService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_services_feed_service__["a" /* FeedService */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */],
...
FeedsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/feeds/feeds/feeds.html"*/'<ion-header>\n	<ion-navbar>\n		<button menuToggle>\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>{{title}}</ion-title>\n	</ion-navbar>\n</ion-header>\n\n<ion-content>\n	<section padding>\n		<h2>{{title}}</h2>\n		<p>{{description}}</p>\n		<div class="list card">\n  <div align="center">\n    <ion-card>\n      <img src="./assets/images/thanks.png"/>\n    </ion-card>\n  </div>\n		</div>\n	</section>\n	<ion-list>\n		<ion-item *ngFor="let feed of feeds" (click)="loadFeed(feed)">\n			<h2>{{feed.title}}</h2>\n			<p>{{feed.summary}}</p>\n			<button ion-button item-right outline>More</button>\n		</ion-item>\n	</ion-list>\n</ion-content>'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/feeds/feeds/feeds.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_3__shared_services_feed_service__["a" /* FeedService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_services_feed_service__["a" /* FeedService */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */],
...
VerificationPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-verification',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/verification/verification.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Verify Account</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div *ngIf="user">\n    <div class="profile">\n      <img src="{{user.img}}" tappable (click)="setPhoto()" />\n    </div>\n    <!-- Show icon of logged in provider -->\n    <h4>\n      <span>{{user.name}} </span>\n      <ion-icon name="md-flame" *ngIf="user.provider == \'Firebase\'" class="firebase"></ion-icon>\n      <ion-icon name="logo-facebook" *ngIf="user.provider == \'Facebook\'" class="facebook"></ion-icon>\n      <ion-icon name="logo-google" *ngIf="user.provider == \'Google\'" class="google"></ion-icon>\n    </h4>\n    <div class="divider"></div>\n    <p>An email confirmation has been sent to: <span>{{user.email}}</span>.</p>\n    <!-- Verification Menu -->\n    <ion-list>\n      <ion-item no-lines tappable (click)="sendEmailVerification()">\n        Resend Confirmation Email\n        <ion-icon name="md-contact" item-right></ion-icon>\n      </ion-item>\n      <ion-item no-lines tappable (click)="setEmail()">\n        Change Email Address\n        <ion-icon name="md-mail-open" item-right></ion-icon>\n      </ion-item>\n      <ion-item no-lines tappable (click)="logout()">\n        Logout\n        <ion-icon name="md-log-out" item-right></ion-icon>\n      </ion-item>\n    </ion-list>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/verification/verification.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */],
...
LawPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'law-page',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/law/law.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Laws</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="article-page">\n<ion-list>\n  <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n  <ion-avatar item-left>\n    <img *ngIf="item.featured_image_urls && item.featured_image_urls.thumbnail" [src]="item.featured_image_urls.thumbnail">\n  </ion-avatar>\n  <h2 [innerHTML]="item.title.rendered"></h2>\n  <p [innerHTML]="item.excerpt.rendered"></p>\n  </button>\n\n</ion-list>\n  <ion-infinite-scroll (ionInfinite)="loadMore($event)">\n <ion-infinite-scroll-content> </ion-infinite-scroll-content>\n</ion-infinite-scroll>\n</ion-content>'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/law/law.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* NavController */]])
], LawPage);
...
YoutubeChannelComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-channel/youtube-channel.html"*/'<ion-header>\n	<ion-navbar>\n		<ion-buttons start>\n			<button ion-button menuToggle>\n				<ion-icon name="menu"></ion-icon>\n			</button>\n		</ion-buttons>\n		<ion-title >{{\'VIDEOS\' | translate}}</ion-title>\n	</ion-navbar>\n</ion-header>\n\n<ion-content padding class="bg-image">\n	<ion-list *ngFor="let video of videos" (click)="loadVideo(video)">\n		<ion-item text-wrap padding class="txt-color" >\n			<ion-thumbnail item-left *ngIf="video.snippet.thumbnails.default.url">\n				<img [src]="video.snippet.thumbnails.default.url">\n			</ion-thumbnail>\n			<h2>{{video.snippet.title}}</h2>\n		</ion-item>\n	</ion-list>\n</ion-content>\n\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-channel/youtube-channel.html"*/,
...
YoutubeChannelVideoComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-channel-video/youtube-channel-video.html"*/'<ion-header>\n	<ion-navbar>\n		<button menuToggle>\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>{{video.snippet.title}}</ion-title>\n        <ion-buttons end>\n          <button (click)="shareVideo()" ion-button icon-only>\n            <ion-icon name="share"></ion-icon>\n          </button>\n        </ion-buttons>\n	</ion-navbar>\n</ion-header>\n\n<ion-content class="youtube-video">\n    <iframe *ngIf="video.id.videoId" [src]="videoUrl" frameborder="0" allowfullscreen="true"></iframe>\n        \n    <div padding>\n        <h2>{{video.snippet.title}}</h2>\n        <p>Published by <strong>{{video.snippet.channelTitle}}</strong></p>\n        <p [innerHtml]="video.snippet.description"></p>\n    </div>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-channel-video/youtube-channel-video.html"*/
    }),
...
ProductListPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-product-list',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/product-list/product-list.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      {{title}}\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <ion-row>\n        <ion-col col-6 col-sm-3 *ngFor=" let item of allItems; let i=index "  >\n            <ion-card style="margin: 0px 0px 0px 0px;   height: 220px;" (click)="openProduct(item)">\n                <div class="frame">\n                    <img class="pimage" src="{{item.attrs.images[0].src}}" />\n                </div>\n                <div style="text-overflow: ellipsis;padding: 4%;font-size: 14px;overflow: hidden;color: #656565; white-space: nowrap;   background: rgba(41, 71, 119, 0.17); ">\n                    {{item.attrs.title}}\n                </div>\n                <div style="text-overflow: ellipsis;overflow: hidden;white-space: nowrap;padding: 4%;font-size: 14px; color: #656565;  ">\n                    <span style="float: left">Price</span><span style="float: right">${{item.variants[0].price}}</span>\n                </div>\n            </ion-card>\n        </ion-col>\n    </ion-row>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/product-list/product-list.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_shopify_client_shopify_client__["a" /* ShopifyClientProvider */]])
], ProductListPage);
...
CheckoutPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-checkout',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/checkout/checkout.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title>Checkout</ion-title>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n    <iframe [src]=\'url ? url : null\'  width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen (load)="onLoad()">\n    </iframe>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/checkout/checkout.html"*/,
    }),
...
YoutubeVideoComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-video/youtube-video.html"*/'<ion-header>\n	<ion-navbar>\n		<button menuToggle>\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>{{video.snippet.title}}</ion-title>\n        <ion-buttons end>\n          <button (tap)="shareVideo()" ion-button icon-only>\n            <ion-icon name="share"></ion-icon>\n          </button>\n        </ion-buttons>\n	</ion-navbar>\n</ion-header>\n\n<ion-content class="youtube-video">\n    <iframe *ngIf="video.snippet.resourceId.videoId" [src]="videoUrl" frameborder="0" allowfullscreen="true"></iframe>\n        \n    <div padding>\n        <h2>{{video.snippet.title}}</h2>\n        <p>Published by <strong>{{video.snippet.channelTitle}}</strong></p>\n        <p [innerHtml]="video.snippet.description"></p>\n    </div>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-video/youtube-video.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["s" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["c" /* DomSanitizer */],
        __WEBPACK_IMPORTED_MODULE_3__ionic_native_social_sharing__["a" /* SocialSharing */]])
...
ImageModalPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-image-modal',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/image-modal/image-modal.html"*/'<ion-content>\n  <div class="content" (click)="close()" tappable>\n    <img src={{image}}/>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/image-modal/image-modal.html"*/
    }),
...
FormsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'forms-page',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/forms/forms.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Forms</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="forms-content">\n  <ion-list class="forms-list">\n    <button class="list-item" ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-row no-padding>\n        <ion-col no-padding class="item-content">\n          <h3 class="item-title">{{item.title}}</h3>\n          <span class="item-note" *ngIf="item.note">{{item.note}}</span>\n        </ion-col>\n        <ion-col no-padding width-10 class="item-icon">\n          <ion-icon name="arrow-forward"></ion-icon>\n        </ion-col>\n      </ion-row>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/forms/forms.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */]])
], FormsPage);
...
PreloadImage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'preload-image',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/components/preload-image/preload-image.html"*/'<ion-spinner name="bubbles"></ion-spinner>\n<ng-content></ng-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/components/preload-image/preload-image.html"*/
    }),
...
BackgroundImage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'background-image',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/components/background-image/background-image.html"*/'<span class="bg-overlay"></span>\n<ion-spinner name="bubbles"></ion-spinner>\n<ng-content></ng-content>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/components/background-image/background-image.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* ElementRef */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* Renderer */]])
], BackgroundImage);
...
ShowHideContainer = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'show-hide-container',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/components/show-hide-password/show-hide-password.html"*/'<ng-content></ng-content>\n<a class="type-toggle" (click)="toggleShow()">\n	<ion-icon class="show-option" [hidden]="show" name="eye"></ion-icon>\n	<ion-icon class="hide-option" [hidden]="!show" name="eye-off"></ion-icon>\n</a>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/components/show-hide-password/show-hide-password.html"*/,
        host: {
...
Rating = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'rating',template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/components/rating/rating.html"*/'<button class="rating-icon" ion-button icon-only round *ngFor="let r of range; let i = index" (click)="rate(i + 1)">\n	<ion-icon [name]="value === undefined ? (r === 1 ? \'star\' : (r === 2 ? \'star-half\' : \'star-outline\')) : (value > i ? (value < i+1 ? \'star-half\' : \'star\') : \'star-outline\')"></ion-icon>\n</button>\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/components/rating/rating.html"*/,
...
YoutubeVideosComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-videos/youtube-videos.html"*/'<ion-header>\n	<ion-navbar>\n		<ion-buttons start>\n			<button menuToggle>\n				<ion-icon name="menu"></ion-icon>\n			</button>\n		</ion-buttons>\n		<ion-title>{{\'YOUTUBE_VIDEOS\' | translate}}</ion-title>\n	</ion-navbar>\n</ion-header>\n\n<ion-content>\n	<ion-list *ngFor="let video of videos" (click)="loadVideo(video)">\n		<ion-item text-wrap>\n			<ion-thumbnail item-left *ngIf="video.snippet.thumbnails.default.url">\n				<img [src]="video.snippet.thumbnails.default.url">\n			</ion-thumbnail>\n			<h2>{{video.snippet.title}}</h2>\n		</ion-item>\n	</ion-list>\n</ion-content>\n\n'/*ion-inline-end:"/Users/yomi/Desktop/application/src/pages/youtube/youtube-videos/youtube-videos.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_2__shared_services_youtube_service__["a" /* YoutubeService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */],
